...
from siqa.data.editor import ContrastNormalizeEditor, ImageNormalizeEditor, \
    PeakNormalizeEditor, FixNormalizeEditor, PatchEditor
...
resolution = 512
base_path = "/gss/r.jarolim/prediction_anomaly_v14/kso_conf2_512"
q2_ds_path = "/gss/r.jarolim/data/anomaly_data_set/quality2"
q1_ds_path = "/gss/r.jarolim/data/anomaly_data_set/quality1"
q2_converted_path = '/gss/r.jarolim/data/converted/q2_%d_v1' % resolution
q1_converted_path = '/gss/r.jarolim/data/converted/q1_%d_v1' % resolution
################################################################
...
if norm == Norm.FIX:
    norm_editor = FixNormalizeEditor()
...
######################### INIT MODEL ################################
model = IQAModel((128, 128, 1), depth=3, discriminator_depth=4, res_blocks=9, base_n_filters=64,
...
valid_provider_A = NumpyProvider(q2_converted_path_validation,
                                 ext_editors=[norm_editor], patch_shape=(resolution, resolution), limit=10)
...
q1_callback = IQAPlot(valid_provider_A, model, prediction_path, log_iteration=1000, plot_id='Q2')
q1_callback.call(0)
